...
def init_weights(model, method = 'Kaiming'):
    ...
    - method: Method of initialization. Kaiming (Kaiming Uniform) and Xavier (Xavier Uniform) supported. By default it is Kaiming
    """
...
def calcular_parametres_del_model(model):
    ...
    Return:
    - pytorch_total_params: Nuumber of parameters (int)
    """
